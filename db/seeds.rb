...
#
# Content.create! name: "Batman", text: <<-CONTENT
...
# CONTENT
#
# Content.create! name: "Superman", text: <<-CONTENT
...
# CONTENT
#
# Content.create! name: "Krypton", text: <<-CONTENT
...
# CONTENT
#
# Content.create! name: "Lex Luthor", text: <<-CONTENT
...
# CONTENT
#
# Content.create! name: "Robin", text: <<-CONTENT
...
# CONTENT
username = Auth::Username.new(name: "admin", password: "password")
user = Auth::User.create(email: "admin@textdepot.com", username:  username)
